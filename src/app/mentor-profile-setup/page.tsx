...
export default function MentorProfileSetup() {
  ...
  const handleExpertiseChange = (area) => {
    setExpertise((prev) => (prev.includes(area) ? prev.filter((item) => item !== area) : [...prev, area]))
  }
      ...
      <div className="max-w-2xl mx-auto bg-white p-8 rounded-lg shadow-lg">
        ...
        <form className="space-y-6">
          ...
          <div>
            ...
            <Textarea id="bio" placeholder="Tell us about yourself and your experience..." />
          </div>
          <div>
          ...
          <div>
            ...
            <p className="text-sm text-muted-foreground mb-2">We'll sync this with your Google Calendar</p>
          ...
          <div>
            ...
            <p className="text-sm text-muted-foreground mt-1">
              Upload documents to verify your expertise (e.g., degrees, certifications)
            </p>
          </div>
