...
export default function LegalInformation() {
  return (
    <div className="px-24 mx-auto p-4 bg-[#ffe5d9] min-h-screen">
      <h1 className="text-[#000] text-2xl font-bold mb-6">Legal Information</h1>
      ...
      <Tabs defaultValue="privacy">
        ...
        <TabsContent value="privacy">
          <h2 className="text-[#000] text-xl font-semibold mb-4">Privacy Policy</h2>
          <p className="text-[#000] mb-4">Last updated: February 8, 2025</p>
        ...
        <TabsContent value="terms">
          <h2 className="text-[#000] text-xl font-semibold mb-4">Terms of Service</h2>
          <p className="text-[#000] mb-4">Last updated: February 8, 2025</p>
          <p className="text-[#000] mb-4">
